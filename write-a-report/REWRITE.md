...
Launch after the draft is complete, before the linter. Sonnet.
...
report exists. Context is what makes an editor protective of wording it can justify. This agent
...
> Rewrite the prose in `<DRAFT_PATH>` so it does not read as model-written. Read `<PROSE_MD_PATH>`
> first; it describes the habits to remove and what the prose should aim at instead.
>
