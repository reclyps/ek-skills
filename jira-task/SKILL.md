...
# <Title>
**Description**
<Typically 3-6 sentences, but scale to the complexity of the task. Explain the background, why this work is needed, and what it achieves. The primary audience is Project/Product team members reading this on a Jira board, but it should also orient the developer who picks up the task.>
...
**Description**: Write for a mixed audience of product and engineering. Explain the problem, the motivation, and what the task achieves at a high level. Do not include implementation details here — save those for requirements.
...
## Audience override
The default audience is Project/Product team members and the implementing developer. If the user specifies a different audience (e.g. "write this for a junior dev" or "this is for leadership"), adjust the tone and detail level accordingly.